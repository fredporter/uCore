...
export interface GridCell {
  ...
  /** Double-height glyph half: "top" renders the upper half of the glyph
   *  scaled to fill the cell; "bottom" renders the lower half. Pairs of
   *  adjacent rows (top above bottom) form one double-height character. */
  dh?: "top" | "bottom";
