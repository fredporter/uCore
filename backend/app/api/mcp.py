...
The Model Context Protocol (MCP) lets compatible external clients
    ...
    tools.append(
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    "workspace_id": {
                        "type": "string",
                        "description": "Workspace ID (omit for all)",
                    },
                },
            },
        }
    ...
    tools.append(
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    "item_id": {
                        "type": "string",
                        "description": "Specific item ID (omit for recent)",
                    },
                    "limit": {
                        "type": "number",
                    ...
                    "include_pinned": {
                        "type": "boolean",
                        "description": "Include pinned items",
                        "default": True,
                    },
                },
            },
    ...
    tools.append(
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "board": {
                        "type": "string",
                        "description": "Board name (default: inbox)",
                        "default": "inbox",
                    },
                    "status": {
                        "type": "string",
    ...
    tools.append(
        {
            ...
            "input_schema": {
                ...
                "properties": {
                    ...
                    "level": {
                        "type": "number",
                        "description": "Precision level (default 340)",
                        "default": 340,
                    },
                },
                "required": ["lat", "lon"],
...
async def handle_mcp_call(request: web.Request) -> web.Response:
    ...
    Accepts multiple payload shapes:
      ...
      - Compatible clients: { "tool": "tool_name", "params": {...} } or { "tool": "tool_name", "input": {...} }
    ...
    if not integrity_report.get("ok", False):
        for check in integrity_report.get("checks", []):
            ...
            if check_name == "syntax":
                ...
                remediation.append("Restore dispatch_tool() in mcp_handlers.py — check git history")
