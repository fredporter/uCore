...
.model-usage-cell { display: flex; align-items: center; gap: var(--usx-spacing-md); min-width: calc(var(--usx-touch-min) * 4); }
...
.model-calls { text-align: right; color: var(--usx-color-on-surface-muted); }
</style>