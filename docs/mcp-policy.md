...
- Add a server entry in .vscode/mcp.json.
- Prefer stdio transport for local development.
- Point to the canonical bridge command and set UCORE_URL explicitly.
- Keep one active implementation and archive legacy configs.
