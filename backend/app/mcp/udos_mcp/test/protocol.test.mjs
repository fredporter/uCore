...
const fixtures = {
  ...
  "/api/developer/repos/uCore/actions": { actions: [{ id: "test" }] },
  "/api/developer/command-runs?repository=uCore": { runs: [], count: 0 },
...
test("calls each backing API with bounded encoded arguments", async () => {
  const calls = [
    ...
    ["developer.commands.list", { repository: "uCore" }],
    ["developer.command-runs.list", { repository: "uCore" }],
