...
.server-table--mono { font-family: var(--usx-font-family-mono); }
...
.server-table td { padding: var(--usx-spacing-sm); border-bottom: var(--usx-border-width) solid var(--usx-color-border); vertical-align: top; }
.log-timestamp { color: var(--usx-color-on-surface-muted); white-space: nowrap; }
.log-service { color: var(--usx-color-primary); white-space: nowrap; }
.log-level { display: inline-block; min-width: 6ch; font-weight: var(--usx-font-weight-semibold); text-transform: uppercase; font-size: var(--usx-font-size-sm); }
