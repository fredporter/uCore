...
def _missing_bridge() -> None:
    raise ImportError("MCP bridge not available")


def _missing_router() -> None:
    raise ImportError("Provider router not available")
